...
#'
#' @keywords internal
in_get_category_labels <- function(color = NULL) {       # list/NULL: custom color grouping list
...
#'
#' @keywords internal
in_get_color_palettes <- function(color = NULL) {        # list/NULL: custom color grouping list
...
#'
#' @keywords internal
in_get_color_group <- function(iso_code,                 # string: country ISO code
    ...
    categories <- in_get_ctry_categories(iso_code)
